...
class Message(CogCore):
            ...
            def filter_channel(ch_name, hello: bool)-> str:
                ...
                if ch_name== 'hennie2001':
                    return choice_emoji_message(
                        key_word= 'moko',
                        hello_emoji_list= ['57', '100', '101', '104', '106', '107', '116', '120', '125', '29', '30', 'Ania', 'Bell', 'CC', 'Ceng1', 'Dance', 'EEE', 'EEEE', 'HAPPY2', 'Hi1', 'Jump', 'Lily1', 'Luo3', 'OLA', 'OMGD', 'OO', 'OOOOO', 'RouRou', 'Sheep1', 'Sheep4', 'Sheep5', 'SHEEPShakey', 'Te'],
                    ...
                    return choice_emoji_message(
                        key_word= 'iiti',
                        hello_emoji_list= ['00', 'Boo', 'Chu', 'CUTE', 'Dance', 'Flap', 'Flower', 'Hii', 'Jump', 'Pr', 'Ring', 'TT1', 'TT2', 'YAA'],
                        hello_fill_word= random.choice(['Loveu', 'Love']),
                    ...
                    return choice_emoji_message(
                        ...
                        return choice_emoji_message(
                            key_word= 'samoagO',
                            hello_emoji_list= ['BearFat', 'child', 'hi', 'flower', 'thumb', 'bearWave', 'wave', 'bla', 'BearDance1', 'clap', 'deer'],
                            hello_fill_word= 'heart',
                            goodnight_emoji_list= ['Sleep', 'warm'],
                            goodnight_fill_word= 'Sleep'
                        )
    ...
    async def message_response(self, message: twitchio.Message):
        ...
        try:
            ...
            elif any(_ in message.content.lower() for _ in ['早安', '安安', '早ㄤ', 'ㄤㄤ' , '早早', '早呀', 'hi', 'happy', 'mokoeee', 'mokoceng1', 'moko104', 'mokolily1', 'hoya', 'migiyaya', 'mumu', 'mokoola', 'mokoceng1', 'mokoomgd', 'mokoooooo', 'bell', 'ring', 'sheep', 'fish6an', 'iitiftb', 'iitinono', 'iiti00', 'iitiboo', 'idol', 'takesichicken', 'call', 'ddd2jump']):
            ...
            self.flag= False
            print("message response choose error:", e)
